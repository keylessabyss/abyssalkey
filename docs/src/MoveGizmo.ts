...
export class MoveGizmo {
    ...
    private outlineAxisBuffer: GPUBuffer;
    ...
    constructor(device: GPUDevice) {
        ...
        const outlineAxis: number[] = [];

        const pushEdge = (a: vec3, b: vec3, axisIndex: number) => {
        ...
        const pushQuad = (id: MovePickId, a: vec3, b: vec3, c_: vec3, d: vec3) => {
            const tri = [
                [a,b,c_],
                [a,c_,d]
            ];
        ...
        // plane faces
        pushQuad(MovePickId.PlaneXY,
            vec3.fromValues(0,0,0),
            vec3.fromValues(s,0,0),
            vec3.fromValues(s,s,0),
            vec3.fromValues(0,s,0)
        );

        pushQuad(MovePickId.PlaneYZ,
            vec3.fromValues(0,0,0),
            vec3.fromValues(0,s,0),
            vec3.fromValues(0,s,s),
            vec3.fromValues(0,0,s)
        );

        pushQuad(MovePickId.PlaneZX,
            vec3.fromValues(0,0,0),
            vec3.fromValues(0,0,s),
            vec3.fromValues(s,0,s),
            vec3.fromValues(s,0,0)
        );
